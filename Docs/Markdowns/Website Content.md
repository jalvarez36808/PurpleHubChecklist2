...
| Top-Level Header | Primary Subheader (Dropdown Title) | Secondary Subheader (When Clicked In) | Reasoning |
| :---- | :---- | :---- | :---- |
| Notifications | Immediate Family | Contacting Immediate Family | Keeps it short in the checklist, while the secondary header clearly shows this is about notifying close relatives. |
| Notifications | Close Friends & Extended Family | Notifying Close Friends and Extended Family | Makes it easy to scan, with fuller description on click to guide tone and content. |
| Notifications | Doctor | Notifying Their Doctor | “Doctor” is short and scannable; secondary header uses full phrasing for clarity. |
| Notifications | Employer | Notifying Their Employer | Keeps the language consistent with “Doctor” and fits the scan/click model well. |
| Care | Children | Arranging Care for Children | Simplifies the dropdown but expands on click to clearly define the task. |
| Care | Pets | Arranging Care for Pets | Same structure; “Pets” is fast to read while full title clarifies scope. |
| Their Wishes | Their Wishes | Determining Your Loved One’s Wishes | Keeps dropdown label empathetic and broad; full phrasing gives context once clicked. |
| Handling the Body | Burial, Cremation, or Donation | Understanding Options for a Loved One’s Remains | Dropdown is simplified to action-oriented categories; clicked title uses full language for compassion and clarity. |
| Handling the Body | Body Transportation | Arranging Transportation of the Body | Shortened header for checklist; detailed title on click-in reflects logistical nature. |
| Funeral Planning | Funeral Home | Choosing a Funeral Home | Keeps dropdown simple, clicked title emphasizes decision-making and compassion. |
| Will & Probate | Will or Probate | How to Determine if There Is a Will and Whether Probate Is Necessary | Clean dropdown language for scannability, full legal phrasing when clicked for users navigating this step. |

## In the Days After the Death of a Loved One

| Top-Level Header | Primary Subheader (Dropdown Title) | Secondary Subheader (When Clicked In) | Reasoning |
| :---- | :---- | :---- | :---- |
| Obtaining a Death Certificate | Death Certificate | How to Request a Death Certificate | Simplified primary label; secondary provides clear guidance on the process. |
| Obtaining a Death Certificate | Copies of the Certificate | How Many Death Certificate Copies You’ll Need | Simplified dropdown; secondary clarifies purpose and context of multiple copies. |
| Obituary Options | Write an Obituary | Writing and Publishing an Obituary | Primary is short; secondary gives users a better sense of action and output. |
| Obituary Options | Facebook Memorial Page | Creating a Facebook Memorial Page | Short and recognizable; secondary highlights user action. |
| Obituary Options | Legacy.com | Using Legacy.com to Share an Obituary | Primary keeps it simple; secondary explains what the platform is for. |
| Obituary Options | Newspaper Obituaries | Submitting an Obituary to a Newspaper | Clear and direct; matches section content. |
| Making Funeral Arrangements | Important Information About Your Loved One | Gathering Information for the Funeral or Memorial Service | Primary avoids jargon; secondary reflects real-world task. |
| Making Funeral Arrangements | Memories and Personal Touches | Collecting Memories to Personalize the Service | Short and approachable; secondary emphasizes purpose. |
| Making Funeral Arrangements | Officiant or Clergy | Choosing Someone to Lead the Service | Simplified dropdown; action-oriented secondary. |
| Making Funeral Arrangements | Music | Planning Music for the Funeral or Memorial Service | Clear, compassionate, and step-based. |
| Making Funeral Arrangements | Flowers or Donations | Coordinating Flowers or Charitable Donations | Primary is short; secondary makes purpose and options explicit. |
| Making Funeral Arrangements | Eulogies | Planning and Supporting Eulogies | Simple and supportive primary; secondary gives clarity on process. |
| Making Funeral Arrangements | Guest Book | Setting Up a Guest Book for the Service | Primary is recognizable; secondary clarifies user’s role. |
| Making Funeral Arrangements | Sharing Service Info | Sharing Funeral Details with Friends and Family | Simple headline; secondary provides helpful context. |
| Making Local Burial Arrangements | Local Burial | Planning a Local Burial Service | Primary is calm and straightforward; secondary outlines main action. |
| Making Local Burial Arrangements | Sharing Burial Info | Sharing Burial Details with Loved Ones | Primary shortens headline; secondary clarifies purpose. |
| Home and Property | Home Care | Securing and Managing Your Loved One's Home | Simplified dropdown; descriptive secondary outlines all tasks. |
| Documents | Important Papers | Gathering Important Legal and Financial Documents | Clear and direct secondary header; avoids overwhelming the user. |
| Financial Assistance | Life Insurance | Claiming a Life Insurance Policy | Primary uses familiar term; secondary clarifies purpose. |
| Financial Assistance | Payment Plans | Exploring Funeral Home Payment Options | Short and inviting; secondary focuses on decision-making. |
| Financial Assistance | Crowdfunding | Setting Up a Funeral Crowdfunding Campaign | Descriptive secondary with emotional and logistical clarity. |
| Financial Assistance | Nonprofit Help | \-Funeral Consumers Alliance\- Modest Needs \-Children's Burial Assistance | Primary uses umbrella term; secondary clarifies type of support. |
| Financial Assistance | Community Support | Finding Local Community Support | Primary stays broad; secondary reflects practical value. |
| Financial Assistance \> Government Benefits | State & Local Aid | Applying for State or Local Funeral Assistance | Straightforward secondary; aligns with content detail. |
| Financial Assistance \> Government Benefits | Bereavement Grants & Stipends | Exploring Bereavement Grants and Burial Stipends | Straightforward secondary; aligns with content detail. |
| Financial Assistance \> Government Benefits | Federal Employee Benefits | Accessing Benefits for Federal Employees and Retirees | Straightforward secondary; aligns with content detail. |
| Financial Assistance \> Government Benefits | Veterans Benefits | Applying for Veterans Funeral and Burial Benefits | Straightforward secondary; aligns with content detail. |
| Financial Assistance \> Employers Assistance | Employer or Union Help | Accessing Benefits from Employers or Unions | Primary combines concepts; secondary shows user what to expect. |
| Financial Assistance | Meal Support | Coordinating Meal Support After a Loss | Primary uses empathetic phrasing; secondary guides user action. |

## In the Weeks After the Death of a Loved One

| Top-Level Header | Primary Subheader (Dropdown Title) | Secondary Subheader (When Clicked In) | Reasoning |
| :---- | :---- | :---- | :---- |
| Close or Redirect Financial and Postal Accounts | Bank Accounts | Managing Your Loved One’s Bank Accounts | Clarifies the task of handling banking matters after death in a calm and direct way. |
| Close or Redirect Financial and Postal Accounts | Credit & Debit Cards | Closing or Settling Credit and Debit Card Accounts | Describes the specific action users are taking and softens the language around 'closing'. |
| Close or Redirect Financial and Postal Accounts | Mail | Redirecting and Managing Mail | Simplifies 'postal' to 'mail' and clearly indicates the action to take. |
| Close or Redirect Financial and Postal Accounts | Digital Accounts | Managing Digital Accounts | Indicates broader scope than just social media, and makes it feel less technical. |
| Close or Redirect Financial and Postal Accounts | Credit Bureaus | Notifying Credit Bureaus About a Death | Gives a clear action while making the legal nature of the task clear. |
| Close or Redirect Home Accounts | Rent or Mortgage | Managing Rent or Mortgage After a Death | Directly describes what the user will be handling in a straightforward way. |
| Close or Redirect Home Accounts | Electric Company | Handling Electric Service and Payments | Keeps it approachable while clarifying that it includes more than just 'notifying'. |
| Close or Redirect Home Accounts | Gas Company | Handling Gas Utility Accounts | Keeps it simple and clearly utility-focused. |
| Close or Redirect Home Accounts | Phone Service | Canceling or Transferring Phone Service | Describes user action while allowing for flexibility based on needs. |
| Close or Redirect Home Accounts | Cable & Streaming Services | Managing Cable and Streaming Subscriptions | Emphasizes both types of accounts in plain language. |
| Notifying State and Federal Agencies | DMV | Canceling a Driver’s License and Updating Vehicle Records | Clarifies that it's both license and car records to avoid confusion. |
| Notifying State and Federal Agencies | Social Security | Notifying the Social Security Administration | Keeps official name while describing the core action. |
| Notifying State and Federal Agencies | Voter Registration | Canceling Voter Registration | Makes it immediately clear what needs to be done. |
| Notifying State and Federal Agencies | Disability Permits | Returning or Canceling Disability Permits | Gives users clear guidance while being respectful. |
| Notifying State and Federal Agencies | IRS | Filing Taxes and Notifying the IRS | Balances the two most common tasks associated with IRS contact. |
| Notifying State and Federal Agencies | Passport | Canceling a U.S. Passport After Death | Straightforward and clear about the action being taken. |
| Completing Notification Process | Email Accounts | Closing or Securing Email Accounts | Clarifies the user’s options while softening the legal tone. |
| Completing Notification Process | Social Media | Managing Social Media Profiles | Gives flexibility for deleting, memorializing, or leaving accounts as-is. |
| Completing Notification Process | Life Insurance | Notifying Life Insurance Providers | Gives clarity and formality appropriate to financial institutions. |
| Completing Notification Process | Long-Term Care Insurance | Canceling Long-Term Care Insurance Policies | Specifies the task clearly and respectfully. |
| Completing Notification Process | Financial Companies | Contacting Financial Institutions | Keeps it broad while still clarifying the purpose. |
| Completing Notification Process | DDNC List | Adding Your Loved One to the Do Not Contact List | Softens the acronym with a more personal framing. |
| Completing Notification Process | Vehicle(s) | Transferring or Disposing of a Loved One’s Vehicle | Covers both common outcomes without sounding harsh. |
...
### Employer (Pop-up) \- Notifying Their Employer
...
### Pets (Pop-up) \- Arranging Care for Pets
...
### Facebook Memorial Page (Pop-up) \- Creating a Facebook Memorial Page
...
### Newspaper Obituaries (Pop-up) \- Submitting an Obituary to a Newspaper
...
### Memories and Personal Touches (Pop-up) \- Collecting Memories to Personalize the Service
...
###  2- Local Burial (Pop-up) \- Planning a Local Burial Service
...
### 2- ► Social Security Lump-Sum Death Benefit (Pop-up) \- Applying for SSA Benefits
...
*Note*: Apply within two years to remain eligible. You may also qualify for monthly survivor benefits if you are a spouse, child, or dependent family member. Ask SSA when applying or see the [Survivor Benefits](#bookmark=kix.dmfr0p263sjl) Pop-up for details.

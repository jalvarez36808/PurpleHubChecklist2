      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 sm:p-10 rounded-2xl shadow-sm border border-gray-100">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-[#6c757d]">
            ...
            <Link to="/signup" className="font-medium text-[#6266ea] hover:text-[#4232c2] transition-colors duration-200">
              Sign up
            </Link>
          </p>
        </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input
                ...
                name="remember-me"
                type="checkbox"
                className="h-4 w-4 text-[#6266ea] focus:ring-[#6266ea] border-gray-300 rounded transition-colors duration-200"
              />
              <label htmlFor="remember-me" className="ml-2 block text-sm text-[#6c757d]">
                Remember me
              </label>
            </div>

            <div className="text-sm">
              <Link to="/forgot-password" className="font-medium text-[#6266ea] hover:text-[#4232c2] transition-colors duration-200">
